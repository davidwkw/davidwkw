...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,ts,js,html,css,py,bash)](https://skillicons.dev)

## Tools
[![My Skills](https://skillicons.dev/icons?i=vscode,git,github,postman,postgres,bash,vim,linux,docker,react)](https://skillicons.dev)
